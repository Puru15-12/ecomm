...
import { getPrriceQueryParams } from '../../helpers/helpers';
...
const Filters = () => {
  ...
  const handleButtonClick =(e) =>{
    ...
    searchParams = getPrriceQueryParams( searchParams, "min" , min );
    searchParams = getPrriceQueryParams( searchParams, "max" , max );
